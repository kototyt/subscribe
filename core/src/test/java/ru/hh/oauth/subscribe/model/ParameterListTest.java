...
public class ParameterListTest {
  ...
  public void shouldAppendNothingToQuerystringIfGivenEmptyMap() {
    ...
    assertEquals(url, params.appendTo(url));
  }
  ...
  public void shouldProperlySortParameters() {
    ...
    assertEquals("a_param=v3&param1=v1&param2=v4&param6=v2", params.sort().asFormUrlEncodedString());
  }
  ...
  public void shouldProperlySortParametersWithTheSameName() {
    ...
    assertEquals("a_param=v3&param1=v1&param1=v4&param6=v2", params.sort().asFormUrlEncodedString());
  }
