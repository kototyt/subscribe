...
import ru.hh.oauth.subscribe.exceptions.OAuthConnectionException;
...
public class Request {
  ...
  private static final RequestTuner NOOP =
    new RequestTuner() {
      @Override
   ...
   *
   * @see  <a href="http://download.oracle.com/javase/1.5.0/docs/guide/net/http-keepalive.html">
   *       http://download.oracle.com/javase/1.5.0/docs/guide/net/http-keepalive.html</a>
   */
   ...
   *
   * @see  <a href="http://docs.oracle.com/javase/6/docs/api/java/net/HttpURLConnection.html#setInstanceFollowRedirects(boolean)">
   *       http://docs.oracle.com/javase/6/docs/api/java/net/HttpURLConnection.html#setInstanceFollowRedirects(boolean)</a>
   */
