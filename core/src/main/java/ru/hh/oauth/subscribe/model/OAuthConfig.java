...
public class OAuthConfig {
  ...
  public OAuthConfig(
      final String key, final String secret, final String callback, final SignatureType type, final String scope, final OutputStream stream,
      final Integer connectTimeout, final Integer readTimeout, final String grantType) {
    this.apiKey = key;
