...
import ru.hh.oauth.subscribe.builder.api.DefaultApi10a;
...
import ru.hh.oauth.subscribe.model.Request;
import ru.hh.oauth.subscribe.model.RequestTuner;
...
import ru.hh.oauth.subscribe.services.Base64Encoder;
import ru.hh.oauth.subscribe.utils.MapUtils;
...
public class OAuth10aServiceImpl implements OAuthService {
  ...
  private String getSignature(final OAuthRequest request, final Token token) {
    ...
    final String signature = api.getSignatureService().getSignature(baseString, config.getApiSecret(), token.getSecret());
