...
public class GoogleToken extends Token {
   ...
   * https://bitbucket.org/nimbusds/nimbus-jose-jwt/wiki/Home Here will be encoded and signed id token in JWT format or null, if not defined.
   */
  ...
  public String toString() {
    return String.format("GoogleToken{'token'='%s', 'secret'='%s', 'openIdToken'='%s']", getToken(), getSecret(), openIdToken);
  }
}
