...
import ru.hh.oauth.subscribe.builder.api.SinaWeiboApi;
...
public class SinaWeiboExample {
  ...
  public static void main(String[] args) {
    ...
    OAuthService service = new ServiceBuilder().provider(SinaWeiboApi.class).apiKey(apiKey).apiSecret(apiSecret).build();
