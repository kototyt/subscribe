...
import ru.hh.oauth.subscribe.builder.api.AWeberApi;
...
public class AWeberExample {
  ...
  public static void main(String[] args) {
    OAuthService service = new ServiceBuilder().provider(AWeberApi.class).apiKey(CONSUMER_KEY).apiSecret(CONSUMER_SECRET).build();
