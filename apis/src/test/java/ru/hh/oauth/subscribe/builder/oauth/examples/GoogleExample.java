...
import ru.hh.oauth.subscribe.builder.api.GoogleApi;
...
public class GoogleExample {
  ...
  public static void main(String[] args) {
    OAuthService service = new ServiceBuilder().provider(GoogleApi.class).apiKey("anonymous").apiSecret("anonymous").scope(SCOPE).build();
