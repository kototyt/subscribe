...
import ru.hh.oauth.subscribe.builder.api.Px500Api;
...
public class Px500Example {
  ...
  public static void main(String[] args) {
    OAuthService service = new ServiceBuilder().provider(Px500Api.class).apiKey("your-api-key").apiSecret("your-api-secret").build();
