...
import ru.hh.oauth.subscribe.builder.api.NeteaseWeibooApi;
...
public class NeteaseWeiboExample {
  ...
  public static void main(String[] args) {
    ...
    OAuthService service = new ServiceBuilder().provider(NeteaseWeibooApi.class).apiKey(apiKey).apiSecret(apiSecret).build();
