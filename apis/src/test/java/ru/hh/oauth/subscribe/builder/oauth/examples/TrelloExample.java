...
import ru.hh.oauth.subscribe.builder.api.TrelloApi;
...
public class TrelloExample {
  ...
  public static void main(String[] args) {
    OAuthService service = new ServiceBuilder().provider(TrelloApi.class).apiKey(API_KEY).apiSecret(API_SECRET).build();
