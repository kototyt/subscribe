...
import ru.hh.oauth.subscribe.builder.api.VkontakteApi;
...
public class VkontakteExample {
  ...
  public static void main(String[] args) {
    ...
    OAuthService service = new ServiceBuilder()
      .provider(VkontakteApi.class).apiKey(clientId).apiSecret(clientSecret).scope("friends,wall,offline") // replace with desired scope
