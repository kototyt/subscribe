...
import ru.hh.oauth.subscribe.builder.api.SohuWeiboApi;
...
public class SohuWeiboExample {
  ...
  public static void main(String[] args) {
    ...
    OAuthService service = new ServiceBuilder().provider(SohuWeiboApi.class).apiKey(apiKey).apiSecret(apiSecret).build();
