...
import ru.hh.oauth.subscribe.builder.api.SkyrockApi;
...
public class SkyrockExample {
  ...
  public static void main(String[] args) {
    OAuthService service = new ServiceBuilder().provider(SkyrockApi.class).apiKey("your-api-key").apiSecret("your-api-secret").build();
